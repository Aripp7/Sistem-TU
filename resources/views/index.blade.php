...
<head>
    ...
    <meta name="title" content="SMAN 1 KECAMATAN GUGUAK" />
    <meta name="description" content="Website Resmi SMAN 1 Kecamatan Guguak" />
    <meta name="keywords" content="SMAN 1 KECAMATAN GUGUAK" />
    ...
    <link rel="stylesheet" href="https://storage.googleapis.com/s2.mysch.id/themes/academy/default/datatables/dataTables.bootstrap4.min.css">


    <!-- Kode Tambahan -->

    <title>SMAN 1 KECAMATAN GUGUAK</title>
    <!--SCRIPT-->
    <script src="https://storage.googleapis.com/s2.mysch.id/themes/academy/js/jquery/jquery-2.2.4.min.js"></script>
</head>
...
<body>
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="https://www.sman1guguak.sch.id/artikel">Artikel</a></li>
                        ...
                        <div class="calling-info">
                            <div class="call-center">
                                <a href="tel:082171824461"><i class="icon-telephone-2"></i></a>
                            </div>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">1</h2>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/17365499371-10.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">10</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/1851983921-5.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">15</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/20816313451-8.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">16</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/20294914421-1.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">4</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/3766119601.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">atas</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/12201901692.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">atas 2</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/1496320023.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">atas 3</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/2251675644.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">atas 4</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('https://www.sman1guguak.sch.id/upload/picture/17519869225.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">atas 5</h2>
                                <a href="" target="_parent" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="about-us-area section-padding-100 js-doc-main-el">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div id="widget">
                ...
                <div class="col-md-6">
                    ...
                    <div id="main">
                        <div class="main">
                            <div class="main_title">Video Kegiatan </div>
                            <div class="main_body">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <div class="text-center mb-4" style="border:1px solid #DADADA;padding:15px;">
                                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=NoI5rdp1Xog" title="Silaturrahmi Mantan Guru dan Tenaga kependidikan d" target="_blank">
                                                <img class="img-fluid" src="https://i3.ytimg.com/vi/NoI5rdp1Xog/hqdefault.jpg" alt="Silaturrahmi Mantan Guru dan Tenaga kependidikan d" width="100%">
                                                <p>
                                                    <h6>Silaturrahmi Mantan Guru dan Tenaga kependidikan d</h6>
                                                </p>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <div class="text-center mb-4" style="border:1px solid #DADADA;padding:15px;">
                                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=qYKrMVzQMrc" title="Kegiatan Ektrakurikuler ROHIS SMA N 1 Kec Guguak" target="_blank">
                                                <img class="img-fluid" src="https://i3.ytimg.com/vi/qYKrMVzQMrc/hqdefault.jpg" alt="Kegiatan Ektrakurikuler ROHIS SMA N 1 Kec Guguak" width="100%">
                                                <p>
                                                    <h6>Kegiatan Ektrakurikuler ROHIS SMA N 1 Kec Guguak</h6>
                                                </p>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <div class="text-center mb-4" style="border:1px solid #DADADA;padding:15px;">
                                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=bbCmFw4gXOg" title="Basket" target="_blank">
                                                <img class="img-fluid" src="https://i3.ytimg.com/vi/bbCmFw4gXOg/hqdefault.jpg" alt="Basket" width="100%">
                                                <p>
                                                    <h6>Basket</h6>
                                                </p>
                                            </a>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <div class="text-center mb-4" style="border:1px solid #DADADA;padding:15px;">
                                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=_O1dB28xRaM" title="Kegiatan Ektrakurikuler ROHIS SMA N 1 Kec Guguak" target="_blank">
                                                <img class="img-fluid" src="https://i3.ytimg.com/vi/_O1dB28xRaM/hqdefault.jpg" alt="Kegiatan Ektrakurikuler ROHIS SMA N 1 Kec Guguak" width="100%">
                                                <p>
                                                    <h6>Kegiatan Ektrakurikuler ROHIS SMA N 1 Kec Guguak</h6>
                                                </p>
                                            </a>
                    ...
                    <div id="main">
                        <div class="main">
                            <div class="main_title">terbaru</div>
                            <div class="main_body"> </div>
                        </div>
                    </div>
                    <hr />
                ...
                <div class="col-md-3">
                    ...
                    <div id="widget">
                        <div class="widget">
                            <div class="widget_title">Basket</div>
                            <div class="widget_body">
                                <a class="popup-youtube" href="https://www.youtube.com/watch?v=bbCmFw4gXOg" title="" target="_blank">
                                    <img class="img-fluid" src="https://i3.ytimg.com/vi/bbCmFw4gXOg/hqdefault.jpg" alt="" width="100%">
                                    <p>
                                        <h6></h6>
                                    </p>
                                </a>
                    ...
                    <div id="widget">
                        <div class="widget">
                            <div class="widget_title">Kegiatan Ektrakurikuler ROHIS SMA N 1 Kec Guguak</div>
                            <div class="widget_body">
                                <a class="popup-youtube" href="https://www.youtube.com/watch?v=qYKrMVzQMrc" title="" target="_blank">
                                    <img class="img-fluid" src="https://i3.ytimg.com/vi/qYKrMVzQMrc/hqdefault.jpg" alt="" width="100%">
                                    <p>
                                        <h6></h6>
                                    </p>
                                </a>
    ...
    <footer class="footer-area">
        <div class="main-footer-area" style="padding:50px 0px;">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div id="footer-widget">
                            <div class="footer-widget">
                                ...
                                <div class="footer-widget_body"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1194.8639183165003!2d100.55170996380781!3d-0.13961550130029746!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xa8865886c2710812!2sSMA%20N%201%20Guguak!5e1!3m2!1sen!2sid!4v1588911837859!5m2!1sen!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bottom-footer-area">
            <div class="container">
                <p>Copyright - 2020-SMAN 1 Kecamatan Guguak - Tim I-Tech</p>
            </div>
        </div>
    </footer>

    <script src="https://storage.googleapis.com/s2.mysch.id/themes/academy/js/bootstrap/popper.min.js"></script>
    <script src="https://storage.googleapis.com/s2.mysch.id/themes/academy/js/bootstrap/bootstrap.min.js"></script>
    <script src="https://storage.googleapis.com/s2.mysch.id/themes/academy/js/plugins/plugins.js"></script>
    <script src="https://storage.googleapis.com/s2.mysch.id/themes/academy/js/active.js"></script>

    <!--TABEL-->
    <script src="https://storage.googleapis.com/s2.mysch.id/themes/academy/default/datatables/jquery.dataTables.min.js"></script>
    <script src="https://storage.googleapis.com/s2.mysch.id/themes/academy/default/datatables/dataTables.bootstrap4.min.js"></script>
    <script src="https://storage.googleapis.com/s2.mysch.id/themes/academy/default/datatables/datatables-demo.js"></script>
